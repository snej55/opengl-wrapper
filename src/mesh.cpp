...
Mesh::Mesh(const std::vector<MeshN::Vertex>& verts, const std::vector<unsigned int>& indexes, const std::vector<MeshN::Tex>& texes)
...
void Mesh::setupMesh() {
    ...
    glBufferData(GL_ARRAY_BUFFER, static_cast<GLsizeiptr>(vertices.size() * sizeof(MeshN::Vertex)), vertices.data(), GL_STATIC_DRAW);
