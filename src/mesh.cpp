...
Mesh::Mesh(const std::vector<MeshN::Vertex>& vertices, const std::vector<unsigned int> &indices, const std::vector<MeshN::Tex> &textures)
...
void Mesh::setupMesh() {
    ...
    glBufferData(GL_ARRAY_BUFFER, vertices.size() * sizeof(MeshN::Vertex), vertices.data(), GL_STATIC_DRAW);
