//
// Created by Jens Kromdijk on 06/04/25.
//
// This is a basic example that renders terrain from a heightmap, using a uniform buffer object to update
// the view and perspective matrices.
//
